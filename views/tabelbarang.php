<?php
if ($menu == "Barang" && $submenu == "StockBarang") {
    ?>
      <div class="card">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <h3 class="card-title mb-0 mr-4">
                        <a href="index.php?menu=Barang&submenu=StockBarang" class="text-dark">Stock Barang</a>
                    </h3>
                    <h3 class="card-title mb-0">
                        <a href="index.php?menu=Barang&submenu=StockSablon" class="text-secondary">Stock Sablon</a>
                    </h3>
                </div>
                <div>
        ...
        <div class="card-body">
            <ul class="nav nav-tabs" id="custom-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="tab-masuk" data-toggle="pill" href="#masuk" role="tab">Stock Masuk</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="tab-data" data-toggle="pill" href="#data" role="tab">Data Stock</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="tab-keluar" data-toggle="pill" href="#keluar" role="tab">Stock Keluar</a>
                </li>
            </ul>
...
<?php
} elseif ($menu == "Barang" && $submenu == "StockSablon") {
?>
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <h3 class="card-title mb-0 mr-4">
                        <a href="index.php?menu=Barang&submenu=StockBarang" class="text-secondary">Stock Barang</a>
                    </h3>
                    <h3 class="card-title mb-0">
                        <a href="index.php?menu=Barang&submenu=StockSablon" class="text-dark">Stock Sablon</a>
                    </h3>
                </div>
                <div>
                    <a href="index.php?menu=CreateBarang&submenu=BarangAdd" class="btn btn-primary">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs" id="custom-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="tab-masuk" data-toggle="pill" href="#masuk" role="tab">Sablon Masuk</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="tab-data" data-toggle="pill" href="#data" role="tab">Data Sablon</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="tab-keluar" data-toggle="pill" href="#keluar" role="tab">Sablon Keluar</a>
                </li>
            </ul>
